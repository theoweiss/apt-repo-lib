...
public class ControlHandler {
  ...
  private void parseControl(PackageEntry packageEntry) throws AptRepoException {
    if (controlContent == null) {
      throw new AptRepoException("no controlContent to parse");
    }
   ...
   */
  public void handle(PackageEntry packageEntry) throws AptRepoException {
